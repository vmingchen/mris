...
We have evaluated our system on a 64-bit Dell server running Cent-OS
Linux with kernel version 3.2.9. We used one SSD and one SATA disk and
created linear and green virtual disk on them. The SSD is a Intel
SSDSA2MH080G1GC 2.5-inch with 80G capacity. The SATA disk is a Toshiba
MHZ2250BK 2.5-inch SATA HDD. Its capacity is 250GB and its rotational
speed is 7200 rpm. 

\subsection{SSD Versus SATA}
