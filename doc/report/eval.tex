...
% TODO: measure the estimate accuracy with quantative metrics

\begin{figure}[t]
\begin{centering}
\epsfig{file=figures/ratio_ops_estimate.eps,width=\linewidth}
...
\begin{figure}[t]
\begin{centering}
\epsfig{file=figures/mris_ratio_iostat_ops.eps,width=1.00\linewidth}
