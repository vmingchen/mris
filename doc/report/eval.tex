...
The predicted mb/sec results, along with the benchmarked mb/sec
results, are presented in Figure~\ref{fig:thputpred}. We observed that
there exist significant discrepancy when ratio is small. This is
something we need to further investigate.
