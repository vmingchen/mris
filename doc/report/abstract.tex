...
system presents up to XXX speedup over the single-tier store using
HDD, or a XXX . Particularly, for a workload emulating Facebook's
photo requests, we improve the throughput by XXX using only a small
Flash of \% of the total storage capacity.
